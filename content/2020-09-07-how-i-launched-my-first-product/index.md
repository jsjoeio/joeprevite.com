...
- [ ] Add egghead Discord link
- [ ] Add party corgi link
- [ ] Add screenshot of conversation with will
- [ ] Add Daniel Vassallo's tweet
- [ ] Add link to two rounds running now
- [ ] Add link to Will, Lauro and Prince profiles
- [ ] Link to plan tweet
- [ ] Add links to foam, vscode, etc.
- [ ] Add link to tweet thread progress of product
- [ ] Add ConvertKit referral link
- [ ] Add ConvertKit Commerce link
- [ ] Add link to product page and landing page
- [ ] Add link to tweet threadf or progress
- [ ] Add link to newsletter, maybe? noo
- [ ] Add link to post on Indie Hackers
- [ ] Insert photo of sales for first three days
- [ ] Add link to ClojureFam
...
[insert photo]
My friend Will and I must have been chatting about it, but when I told him the idea, he was all for it. He had his own book idea in mind. We both we would push each other in that direction of coming up with an idea, and starting to write it.

### The tweet that inspired it all

[insert photo]

Then, we saw this tweet. This was back in July and I immediately bookmarked it. I told myself in August, I would give it a shot. I chatted with Will and he said was onboard to join me as well for the challenge.
...
He suggested I post the challenge to the egghead and party-corgi Discords. It was a fantastic idea.

I ended up receiving more requests than I could handle. I chose Discord Group DMs, which are capped at 10 people. I told the other folks there would be a future round, which has two groups running as I write this.
...
This worked out surprisingly well. I wasn't able to customize how I might if I were writing the HTML, but using their builder allowed me to focus on the landing page copy. I didn't have to make decisions about the design (beyond a few colors) or the tech stack. It saved a lot of mental work!
...
While ConvertKit Commerce is still in beta, you can sign up here.
...
When I started building this, was two-thirds done with another project I started: ClojureFam. Naive me thought, "Oh yeah. I can do both at the same time." But after a few days, I noticed my progress on the ClojureFam project dwindling. I put that on pause and focused on the product.
