...
- [Notes](#notes)
  - [Introduction](#introduction)
    - [hashes vs hashmaps vs dictionaries vs objects](#hashes-vs-hashmaps-vs-dictionaries-vs-objects)
    - [first class functions](#first-class-functions)
    - [Thorsten was right](#thorsten-was-right)
  - [Chapter 1 - Lexing](#chapter-1---lexing)
    - [lexical analysis, lexing, and lexer](#lexical-analysis-lexing-and-lexer)
    - [identifiers](#identifiers)
    - [token types](#token-types)
    - [underscores in identifiers](#underscores-in-identifiers)
    - [skipWhitespace](#skipwhitespace)
    - [keywords](#keywords)
    - [repl means something](#repl-means-something)
  - [Chapter 2 - Parsing](#chapter-2---parsing)
    - [serialization languages](#serialization-languages)
    - [syntactic analysis](#syntactic-analysis)
    - [parser generator](#parser-generator)
    - [top-down vs bottom-up vs recursive decent parsing](#top-down-vs-bottom-up-vs-recursive-decent-parsing)
    - [binding vs identifier vs expression](#binding-vs-identifier-vs-expression)
    - [AST with Nodes](#ast-with-nodes)
    - [operator precedence](#operator-precedence)
    - [prefix vs infix operators](#prefix-vs-infix-operators)
    - [binary operators](#binary-operators)
    - [Vaughan Pratt](#vaughan-pratt)
    - [terminology](#terminology)
    - [IntegerLiteral](#integerliteral)
    - [prefixParseFns and infixParseFns](#prefixparsefns-and-infixparsefns)
    - [parseBoolean](#parseboolean)
    - [grouped expressions](#grouped-expressions)
    - [block statements](#block-statements)
    - [infix parse functions](#infix-parse-functions)
    - [serialization](#serialization)
  - [Chapter 3 - Evaluation](#chapter-3---evaluation)
    - [interpreters vs compilers](#interpreters-vs-compilers)
    - [tree-walking interpreters](#tree-walking-interpreters)
    - [intermediate representation](#intermediate-representation)
    - [just in time](#just-in-time)
    - [host language](#host-language)
    - [two instances of boolean](#two-instances-of-boolean)
    - [unary operator expression](#unary-operator-expression)
    - [eight infix operators](#eight-infix-operators)
    - [comparing values directly](#comparing-values-directly)
    - [return statements](#return-statements)
    - [bindings](#bindings)
    - [environment](#environment)
    - [first-class citizens](#first-class-citizens)
  - [Chapter 4 - Extending the Interpreter](#chapter-4---extending-the-interpreter)
    - [built-in functions](#built-in-functions)
    - [validate hash keys in evaluation stage](#validate-hash-keys-in-evaluation-stage)
  - [Chapter 5 - Macro System](#chapter-5---macro-system)
